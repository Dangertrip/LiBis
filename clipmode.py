...
#        break
 ...
 #           print(line1[0][1:])
                ...
                temp = line1[0]
                if length>1: temp+='_'+str(string_mark)
...
if __name__=="__main__":
    ...
    for l in lines:
        ...
        do_process(l.strip().split(),{'ref':'/data/dsun/ref/mouseigenome/mm10.fa','step':5,'window':30,'cleanmode':True}) #pass file name to do_process
    #pool.close()
    #pool.join()
