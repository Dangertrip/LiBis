...
4. Modified the default value of window size, filter size based on AUC.
5. Fixed bugs in reading reads name from bam file.
6. Now remove the filter.bam after alignment.
7. Generate summary table after alignment.
